let c2c_serverConfig = {
     domain: "barkwopqstpe.sip1-region2.audiocodes.io",
...
let c2c_config = {
    // Call
    call: '+12128856581', // Call to this user name (or phone number). Special value: '_take_value_from_url_' to set the value from URL 'call' parameter
    caller: '+19298955205', // Caller user name (One word according SIP RFC 3261). 
    callerDN: '+19298955205', // Caller display name (words sequence).
